...
let CreateEventComponent = class CreateEventComponent {
    constructor() { }
    ngOnInit() {
        const quickviews = _node_modules_bulma_quickview_dist_js_bulma_quickview_js__WEBPACK_IMPORTED_MODULE_3___default.a.attach();
        const calendars = _node_modules_bulma_calendar_dist_js_bulma_calendar_js__WEBPACK_IMPORTED_MODULE_2___default.a.attach('[type="date"]');
    }
};
...
let HomeComponent = class HomeComponent {
    ...
    ngOnInit() {
        this.http.get('').subscribe(events => {
            this.events = events;
        });
    }
};
...
let NavbarComponent = class NavbarComponent {
    constructor(http, router, userEventsService) {
        this.http = http;
        this.router = router;
        this.userEventsService = userEventsService;
        this.loggedIn = false;
    ...
    fetchUserEvents() {
        this.http.get('/festivalApp/details').subscribe(assignedEvents => {
    ...
    ngOnInit() {
        const quickviews = _node_modules_bulma_quickview_dist_js_bulma_quickview_js__WEBPACK_IMPORTED_MODULE_2___default.a.attach();
        //const assignedEvents: AssignedEvent[];
        let event = new _shared_event_model__WEBPACK_IMPORTED_MODULE_6__["Event"](1, 2, 'Lollapalooza', 'Tampa, Fl', '8/7/19', '8/10/19', 'consectetur adipisicing elit. Dolorum sapiente explicabo, corporis totam! Labore reprehenderit beatae');
        let eventTwo = new _shared_event_model__WEBPACK_IMPORTED_MODULE_6__["Event"](55, 2, 'Lollapalooza', 'Tampa, Fl', '8/7/19', '8/10/19', 'consectetur adipisicing elit. Dolorum sapiente explicabo, corporis totam! Labore reprehenderit beatae');
        this.assignedEvents = [
...
class AssignedEvent {
    constructor(eventRole, event, eventStartDate, eventEndDate) {
...
class EventDay {
    constructor(day, stages) {
        this.day = day;
        this.stages = stages;
    }
}
EventDay.ctorParameters = () => [
    { type: Date },
    { type: Array }
];
...
class Event {
    constructor(eventNumer, audienceCapacity, eventName, eventLocation, startDate, endDate, eventDescription) {
...
class Performance {
    constructor(start, end, artist, number) {
        this.start = start;
        this.end = end;
        this.artist = artist;
        this.number = number;
...
let d = new Date();
d.setDate(24);
let StageScheduleComponent = class StageScheduleComponent {
    // eventDays: EventDay[] = [
